export const SHARED_MODEL_CONTEXT_CONTRACT = "chassis.shared_model_context.v1";
...
export interface CoveredEntrypoint {
  entrypoint: "interactive" | "chassis ask" | "ACP" | "subagent";
...
export const AGENT_QUALITY_BASELINE_MATRIX: readonly AgentQualityMatrixRow[] = [
  ...
  },
  {
    ...
    userPrompt: "Look for changes/last commits in chassis.",
    ...
    coveredEntrypoints: [
      askEntrypoint("Depends on repo_identity in chassis.shared_model_context.v1."),
    ],
  },
  {
    ...
    currentBaselineResult: {
      status: "partial",
      notes:
        "Live ./zig-out/bin/chassis ask --auto --json --no-save answered from existing context with zero tool calls. First tool: none; forbidden tools: none; behavior cited src/core/slash_commands/command_specs.zig but did not perform local discovery first.",
    },
    targetResult:
      "Starts with local discovery and identifies src/core/slash_commands/command_specs.zig from local evidence.",
    coveredEntrypoints: [
      askEntrypoint("Uses workspace_identity and available_tools from chassis.shared_model_context.v1."),
    ],
  },
  {
    ...
    currentBaselineResult: {
      status: "passing",
      notes:
        "Live ./zig-out/bin/chassis ask --auto --json --no-save used grep_files first and made five grep_files calls total. Forbidden tools: none; behavior reported concrete local matches in command_policy.zig, tool_permission.zig, and terminal.zig.",
    },
    targetResult: "Uses local search tools only and reports concrete local matches.",
    coveredEntrypoints: [
      askEntrypoint("Depends on available_tools and workspace_identity from chassis.shared_model_context.v1."),
    ],
  },
  {
    ...
    coveredEntrypoints: [
      askEntrypoint("Applies to long --auto --json local source investigations in chassis ask."),
  ...
  },
  {
    ...
    currentBaselineResult: {
      status: "passing",
      notes:
        "Live ./zig-out/bin/chassis ask --auto --json --no-save used read_file first, then a second read_file. Forbidden tools: none; behavior inspected MCP runtime/docs before answering and did not ask the user.",
    },
  ...
  },
  {
    ...
    coveredEntrypoints: [
      askEntrypoint("Depends on repo_identity and workspace_identity from chassis.shared_model_context.v1."),
  ...
  },
  {
    ...
    coveredEntrypoints: [
      askEntrypoint("Depends on repo_identity and available_tools from chassis.shared_model_context.v1."),
    ],
  },
  {
  ...
  },
  {
    ...
    userPrompt: "Read https://github.com/adhyaay-karnwal/chassis/pull/57 comments.",
    failureCategory: "GitHub routing",
    expectedFirstTool: {
      category: "GitHub CLI metadata read",
      tools: ["shell"],
    ...
    deterministicCoverage: {
      ...
      status: "planned",
      notes:
        "Concrete public PR fixture chosen; a recorded JSON fixture can assert gh routing for adhyaay-karnwal/chassis#57.",
    },
    modelBackedEval: {
      required: true,
    ...
    currentBaselineResult: {
      status: "passing",
      notes:
        "Live ./zig-out/bin/chassis ask --auto --json --no-save used shell.run first with gh pr view 57 --repo adhyaay-karnwal/chassis --comments. Forbidden tools: none; behavior summarized PR review comments and bot deploy comments from gh output.",
    },
  ...
  },
  {
    ...
    coveredEntrypoints: [
      interactiveEntrypoint("Depends on session_metadata from chassis.shared_model_context.v1."),
  ...
  },
  {
    ...
    coveredEntrypoints: [
      interactiveEntrypoint("Depends on session_metadata in chassis.shared_model_context.v1."),
  ...
  },
  {
    ...
    coveredEntrypoints: [
      interactiveEntrypoint("Uses session_metadata from chassis.shared_model_context.v1."),
  ...
  },
  {
    ...
    coveredEntrypoints: [
      askEntrypoint("Uses permission_mode and available_tools from chassis.shared_model_context.v1."),
  ...
  },
  {
    ...
    coveredEntrypoints: [
      interactiveEntrypoint("Uses workspace_identity and session_metadata from chassis.shared_model_context.v1."),
  ...
  },
  {
    ...
    coveredEntrypoints: [
      askEntrypoint("Depends on available_tools and web routing prompt guidance in chassis.shared_model_context.v1."),
    ],
  },
  {
  ...
  },
  {
    ...
    coveredEntrypoints: [
      askEntrypoint("Depends on session_metadata and available_tools from chassis.shared_model_context.v1."),
  ...
  },
  {
    ...
    currentBaselineResult: {
      status: "passing",
      notes:
        "shell.interact exposes only chassis-owned execution output for the exact returned handle.",
    },
    targetResult:
