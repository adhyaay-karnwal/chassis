...
fn composeSelectionFailureRow(
    ...
    const message = switch (failure) {
        .open_elsewhere => "This session is open in another chassis. Close it there, then press enter to retry.",
...
test "resume menu explains retryable selected session contention" {
    ...
    const cases = [_]struct {
        ...
        .{
            ...
            .message = "This session is open in another chassis. Close it there, then press enter to retry.",
        },
        .{
