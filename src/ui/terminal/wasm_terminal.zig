...
extern "chassis" fn chassis_term_size(cols: *u16, rows: *u16) void;
extern "chassis" fn chassis_term_poll_input(timeout_ms: i32) i32;
...
pub fn pollInput(timeout_ms: i32) i32 {
    return chassis_term_poll_input(timeout_ms);
}
