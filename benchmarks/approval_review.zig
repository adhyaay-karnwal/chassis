...
const chassis = @import("benchmark_exports");

const approval_prompt = chassis.approval_prompt;
const approval_screen = chassis.approval_screen;
const diff_mod = chassis.diff;
const interaction_state = chassis.interaction_state;
const transcript_blocks = chassis.transcript_blocks;
const vt_emulator = chassis.vt_emulator;

const Allocator = std.mem.Allocator;
const TranscriptRuntime = chassis.TranscriptRuntime;
...
const transcript_head = "CHASSIS_TRANSCRIPT_HEAD_SENTINEL";
const transcript_middle = "CHASSIS_TRANSCRIPT_MIDDLE_SENTINEL";
const transcript_tail = "CHASSIS_TRANSCRIPT_TAIL_SENTINEL";
const diff_head = "CHASSIS_DIFF_HEAD_SENTINEL";
const diff_middle = "CHASSIS_DIFF_MIDDLE_SENTINEL";
const diff_tail = "CHASSIS_DIFF_TAIL_SENTINEL";
const payload_head = "CHASSIS_LARGE_PAYLOAD_HEAD_SENTINEL";
const payload_tail = "CHASSIS_LARGE_PAYLOAD_TAIL_SENTINEL";
...
fn fileRequest() chassis.permission_request.PermissionRequest {
    return .{
        .id = 0xA990,
...
fn layout(cols: u16, rows: u16) chassis.types.Layout {
    return .{
        .rows = rows,
        .cols = cols,
        .content_bottom = 1,
...
fn setDocumentTarget(
    ...
    state: *interaction_state.ApprovalScreenState,
    transcript: []const u8,
    active_layout: chassis.types.Layout,
...
fn runPhase(
    ...
    var transcript_source: ?chassis.TranscriptPreparationSource = null;
